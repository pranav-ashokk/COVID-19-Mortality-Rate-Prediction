...
This project aims to provide detailed statistical analysis and create accurate predictive models of the COVID-19 outbreak. The primary predictive model is a model that predicts the number of deaths caused by COVID-19 in the U.S. 
